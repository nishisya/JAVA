...
public class GameEngine {
        ...
        try {
            ...
            if (choice >= 0 && choice < wildPokemon.size()) {
                ...
                if (attemptCatch(targetPokemon)) {
                    System.out.println("Success! You caught " + targetPokemon.getName() + "!");
 ...
 // Damage formula using attackPower and type effectiveness
    ...
    private void attemptCatchDefeatedPokemon(Pokemon wildPokemon) {
        System.out.println("\nCatch Time! A wild Pokémon is defeated.");
        ...
        if (caught) {
            System.out.println("You caught " + wildPokemon.getName() + " using a " + selectedBall.getName() + "!");
            player.addPokemon(wildPokemon);
        } else {
            System.out.println("The " + wildPokemon.getName() + " escaped from the " + selectedBall.getName() + "!");
        }
    ...
    public void showPostBattleMenu() {
        ...
        while (running) {
            ...
            switch (input) {
                ...
                case "3" -> selectBattleTeam();//displayGaoLeDisks(); NOT YET SET
                case "4" -> {// Exit
